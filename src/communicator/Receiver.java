...
public class Receiver {
    ...
    int port_no;
    Element elem;
    //identifies the system and properties on which the service is runnig on
    HttpServer server;
    Handler handle;
    ...
    public final void setServer() throws IOException {
        ...
        handle = new Handler(elem, node_data, node_pqueue);
     ...
     * Starts the server
     * <br>
     * The server starts receiving at the port.The setServer() method should be
